...
function RedefinicaoSenha() {
  ...
  const errors = {
    codigoRecuperacao:
      obrigatorio(codigoRecuperacao) || min(codigoRecuperacao, 6),
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>
        <Text>
          Agora, informe abaixo o código que foi enviado para o e-mail informado
          e a nova senha a ser cadastrada.
        </Text>
      </Text>
      <Text style={styles.label}>
        Código de recuperação: *
        {formSubmetido && errors.codigoRecuperacao && (
          <Text style={styles.textoValidacao}>
            {`\b${errors.codigoRecuperacao}`}
          </Text>
        )}
      </Text>
      <TextInput
        ...
        onChangeText={(text) => setCodigoRecuperacao(text)}
