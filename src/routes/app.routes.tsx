...
const AppRoutes: React.FC = () => {
  ...
  return (
    <AppStack.Navigator
      initialRouteName={
        !usuarioLogado?.perfilSelecionado ? "SelecaoPerfil" : "Inicial"
      }
    ...
    >
      ...
      <AppStack.Screen
        name="NegociacaoFinalizada"
        component={NegociacaoFinalizada}
      />
      <AppStack.Screen name="AlteracaoSenha" component={AlteracaoSenha} />
      <AppStack.Screen
        name="AtualizacaoCadastro"
        component={AtualizacaoCadastro}
      />
      <AppStack.Screen
        name="InformacaoRetirada"
        component={InformacaoRetirada}
      />
